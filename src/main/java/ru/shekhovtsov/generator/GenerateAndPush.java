...
public class GenerateAndPush {
    ...
    private static final int FILE_SIZE = 1024; // Размер файла в байтах (не используется в этом примере)


    @Scheduled(fixedDelay = 3600000)
    static void generateAndPush() throws IOException, InterruptedException {
        // Генерация файлов
